...
from crypten.mpc.primitives.arrayAccess import SecureArrayAccess, where
...
class Greater(Module):
    ...
    def forward(self, inputs):
        ...
        return torch.greater(tensorA, tensorB)
